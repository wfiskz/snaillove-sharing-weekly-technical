		...
		<div class="right-box rounded">
			...
			<div class="tb-box">
				<table class="tb" cellspacing="0" cellpadding="0">
					<tr>
						<td width="30%"><Label>轮播图名称：</Label></td>
						<td align="left"><span> <input type="hidden" id="id"
								value="${slide.id}"> <input type="hidden"
								id="createtime" value="${slide.createtime}"> <input
								class="form-control" placeholder="请填写" type="text" id="title"
								value="${empty slide.lname?'':slide.lname}"
					...
					<tr>
						...
						<td align="left"><span> <input type="hidden" id="id"
								...
								value="${empty slide.contenturl?'':slide.contenturl}"
								style="width: 270px;height: 30px;">
						</span></td>
					</tr>
					<tr>
						...
						<td align="left" width="350" height="130">
							<div class="form-group">
								<div class="col-md-7">
									...
									<input type="hidden" id="fileName" value="${slide.photourl}" />
								</div>
							</div>
						</td>
					</tr>
					<tr>
						...
						<td align="left"><select name="status" id="status"
							class="input" style="width: 270px;height: 30px;">
								<option value="0"
									<c:if test="${slide.isdel==0}"> selected="selected"</c:if>
									<c:if test="${empty slide.isdel}"> selected="selected"</c:if>>显示</option>
								<option value="1"
									<c:if test="${slide.isdel==1}"> selected="selected"</c:if>>隐藏</option>
						</select></td>
					</tr>
					<tr>
						...
						<td align="left"><span> <input class="form-control"
								...
								value="${empty slide.sort?'':slide.sort}"
								style="width: 270px;height: 30px;"
					...
					<tr>
						<td colspan="2" align="center">
							<div class="btn-box">
								<input class="input" onclick="addOrUppSlide()" type="button"
									value="确 定"> <input class="input" type="button"
									onclick="getSlide(1)" value="返 回">
