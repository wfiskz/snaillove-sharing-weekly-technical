...
//            alert(result.message);
     ...
     */
    this.addItem3 = function(all, act)
    {
...
//            alert("厂商关联分类------->code"+code+"----id"+zidingyi_id+"---zidingyi_name"+zidingyi_name);
            ...
            var url ="/music/web/associatedLabel_vendor.action";
            var result = Object();
     ...
     * @param   string     act
     */
    this.dropItem3 = function(all, act)
    {
        if (!this.check())
        {
            return;
...
//             alert(ids);
            ...
            var url = "/music/web/delVendorLabel.action";
            $.post(
            	url, {"id": id,"code":code},
            function(data) {
            		  try {
